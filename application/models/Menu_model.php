...
class Menu_model extends CI_Model {
    ...
    function get_disocunt_page() {
        ...
        $list.="<div class='mobile_discount' style='text-align:center;'><img src='/assets/images/mobile_discount.jpg' class='img-responsive' alt='Discount'></div>";
    ...
    function get_news_by_date($start, $end) {
        ...
        if ($num > 0) {
            ...
            foreach ($news as $new) {
                ...
                $list .= "<td style='padding:5px;' width='5%'><a href='#' onClick='return false;' style='color:black;'><img id='edit_news_$new->id'   src='/assets/images/edit.png' width='32' height='32' title='Редактировать'></a></td>";
                $list .= "<td style='padding:5px;' width='5%'><a href='#' onClick='return false;' style='color:black;'><img id='delete_news_$new->id' src='/assets/images/delete.png' width='32' height='32' title='Удалить'></a></td>";
                $list .= "</tr>";
