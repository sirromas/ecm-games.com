<?php
print_d($config);
    require_once($config -> get_admin_template_fullpath()."modules/doctype.php");
?>
<html xmlns="http://www.w3.org/1999/xhtml">
<?php
    require_once($config -> get_admin_template_fullpath()."modules/head.php");
?>
<body>
    <div id="wrapper">
<?php
...
Lorem ipsum dolor sit amet, consectetur adipiscing elit.
      ...
      <a class="media-left" href="#">
          <img src="<?= $config -> get_admin_template_fullpath() ?>assets/img/1.jpg" alt="" class="img-rounded" />
      </a>
    ...
    <div class="media">
      <a class="media-left" href="#">
          <img src="<?= $config -> get_admin_template_fullpath() ?>assets/img/2.jpg" alt="" class="img-rounded" />
      </a>
      <div class="media-body">
        <h4 class="media-heading">Media heading</h4>
       Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. 
